...
// Check extension
    if (in_array($imageFileType, $extensions_arr)) {
        ...
        $sql="UPDATE meniul_zilei SET denumire='$denumire', descriere='$descriere', poza='$name', pret='$pret' where id='$id'";
    ...
    $descriere = $_POST['descriere'];
    $pret= $_POST['pret'];
    $sql="UPDATE meniul_zilei SET denumire='$denumire', descriere='$descriere' , pret='$pret' where id='$id'";
    if (mysqli_query($conn, $sql)) {
...
<div class="wrapper style1">
    ...
    <form action="" method="post" >
        ...
        $sql ="SELECT * FROM meniul_zilei where id='$id'";
