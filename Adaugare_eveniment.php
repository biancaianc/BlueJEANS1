...
if (isset($_POST['adauga'])&&(isset($_FILES['file'])) &&isset($_POST['denumire'])&&isset($_POST['descriere'])){
    ...
    if( in_array($imageFileType,$extensions_arr) ){
        ...
        // Insert record
        $query = "insert into evenimente(poza, denumire, descriere, numar_locuri, data) values('".$name."','$denumire','$descriere','$numar_locuri','$data')";
...
<div class="wrapper style1">
    ...
    <form action="" method="post" enctype='multipart/form-data'>
        ...
        <font size="6" color=white><strong>Descriere</strong><br><input name="descriere" type="text" placeholder="descriere..." size="25" required><br></font><br>
        <font size="6" color=white><strong>Numar locuri</strong><br><input name="numar_locuri" type="number" placeholder="numar locuri..." size="25" required><br></font><br>
        <font size="6" color=white><strong>Data eveniment</strong><br><input name="data" type="date" placeholder="data..." size="25" required><br></font><br>
